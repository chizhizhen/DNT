...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
template<typename Dtype>
void PoolingLayer<Dtype>::Reduce(vector<Blob<Dtype>*>* bottom, const vector<Blob<Dtype>*>& top) {
  // Copy select vector from top to bottom blobs
  (*bottom)[0]->reset_select();
  caffe_copy((*bottom)[0]->channels(), top[0]->cpu_select(),
  ...
  (*bottom)[0]->Reshape(bottom_num, bottom_channels, height_, width_);
