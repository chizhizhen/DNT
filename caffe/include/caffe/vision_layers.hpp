...
class ConvolutionLayer : public Layer<Dtype> {
 public:
  ...
  virtual void ReduceTop(vector<Blob<Dtype>*>* bottom,  vector<Blob<Dtype>*>* top);
...
class PoolingLayer : public Layer<Dtype> {
 public:
  ...
  virtual void Reduce(vector<Blob<Dtype>*>* bottom, const vector<Blob<Dtype>*>& top);
  virtual void ReduceTop(vector<Blob<Dtype>*> bottom, vector<Blob<Dtype>*>* top) {
    LOG(FATAL) << "PoolingLayer::ReduceTop is not implemented. Please use ConvolutionLayer as the output layer.";
  }
